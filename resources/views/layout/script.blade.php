...
<script src="../assets/js/proyectos/detallesProy.js"></script>

<script src="../assets/js/proyectos/selecMultiplebotones.js"></script>
<script src="../assets/js/selectorMultiple.js"></script>
<script src="../assets/js/distrito/actualizacionzona.js"></script>
<script src="../assets/js/detallesGenerales/ejecutarApoyo.js"></script>
<script src="../assets/js/agendar/formulario.js"></script>
