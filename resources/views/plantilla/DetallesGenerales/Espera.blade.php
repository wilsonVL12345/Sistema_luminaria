									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr class="text-start text-gray-500 fw-bold fs-7">
											...
											<!--end::Modal - imagen carta-->
												...
												<div class="modal fade" id="modalModificarDetalleEspera" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
													<!--begin::Modal dialog-->
													<div class="modal-dialog mw-1000px">
														...
														<div class="modal-content">
															...
															<div class="modal-header">
																<!--begin::Title-->
																<h2>Modificar Datos de trabajos a Realizar</h2>
																<!--end::Title-->
																<!--begin::Close-->
																<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
																	<!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
															...
															<div class="modal-body scroll-y m-5">
																...
																<div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
																	...
																	<!--begin::Form-->
																	<!--begin::Form-->
																	<form action="{{route('agendar.trabajo')}}" id="formModificarDetalleEspera" method="POST" enctype="multipart/form-data">
																		@csrf
																		...
																		<div class="from row">
																			<div class="col-md-3 mb-3">
																				...
																				name="sldistespera" data-select-id="sldistesper">
																				<option value="" >Seleccione...</option>
																				@foreach ($listadistrito as $item)
																				<option value="{{$item->id}}" {{$item->id==$itemEspera->Distritos_id ? 'selected' : ''}}>{{$item->Distrito}}</option>
																			...
																			<div class="col-md-6 mb-3">
																				<label for="slturbanizacion" class="required fs-5 fw-bold mb-2">Urbanizacion</label>
																				<select  aria-label="Select a Country"
																				data-control="select2"
																				data-placeholder="Seleccionar Urbanizacion"
																				data-dropdown-parent="#modalModificarDetalleEspera"

																				class="form-control form-select-solid fw-bolder" name="slturbanizacio"  data-select-id="slturbanizacion">
																		...
																		<div class="from row">
																			<div class="col-md-6 mb-3">
																				...
																				<select class="form-control form-select-lg form-select-solid" name="selectedStatess[]" data-select-id="selectorr" data-control="select2"  data-placeholder="Seleccione..." data-allow-clear="true" multiple="multiple" required>
																			...
																			<div class="col-md-3 mb-3" id="apoyo--distrito" style="display: none;">
																				...
																				<select class="form-control form-select-solid"   data-control="select2" data-hide-search="true" data-placeholder="Selecione..." name="txt-apoyo" id="txt-apoyo"  >
																					<option value="" >Seleccione...</option>
																					@foreach ($listadistrito as $item)
