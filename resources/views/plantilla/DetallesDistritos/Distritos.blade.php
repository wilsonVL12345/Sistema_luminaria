												...
												<div class="margin">
													...
													<div id="kt_content_container" class="container-xxl">
														...
														{{-- <div class="card card-p-0 card-flush">
															...
															<div class="card-body">
																<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="tablaurbanizacion">
																	<thead>
																		<!--begin::Table row-->
																		<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase">
																			<th class="min-w-100px">Distrito </th>
																			<th class="min-w-100px">Urbanizacion</th>
																			<th class="min-w-100px">Latitud</th>
																			<th class="min-w-100px">Longitud </th>
																	...
																	<tbody class="fw-semibold text-gray-600">
																		...
																		<tr class="text-start text-gray-500 fw-bold fs-7">
																			...
																			<td>
																				<div class="text-gray-900 text-hover-primary">{{$itemurb->lng}}</div>
																			</td>
																			<td>
																				<a href="#" class="text-gray-900 text-hover-primary">{{$itemurb->lat}}</a>
																			</td>
																			<!--begin::Action=-->
																			<td class="text-end">
																				...
																				<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
																					...
																					<!--begin::Menu item-->
																					<div class="menu-item px-3">
																						<a href="{{url('/datos/ejecutar/'.$itemurb->id)}}" 
