						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Luminarias  Detalles</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="card mb-5 mb-xl-10">
									<div class="card-body pt-9 pb-0">
										...
										<form action="/search_results" method="get">
											<label for="search_query">Buscar por:</label><br>
											...
											<table>
													...
													<!-- Replace the following rows with actual search results -->
													<tr>
														<td>10/01/24</td>
														<td>123SDF</td>
														<td>8</td>
														...
														<td>sef564-e</td>
														<td>wils S.R.L</td>
														<td><img src="path/to/carta_image.jpg" alt="Carta imagen"></td>
