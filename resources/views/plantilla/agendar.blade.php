								...
								<div class="card mb-5 mb-xl-10">
									<div class="card-body pt-9 pb-0">
										<h1>Agendar Trabajo</h1>
											<form action="/submit_trabajo" method="post">
											...
											<select id="trabajo" name="trabajo" required>
												...
												<option value="apoyo_carro_canasta">apoyo carro canasta</option>
												<option value="instalacion_lum_led">instalación lum led</option>
												<option value="insta_y_mante">instalación y mantenimiento</option>
											</select><br>

											<label for="observaciones">Observaciones:</label><br>
											<textarea id="observaciones" name="observaciones" required></textarea><br>

											<label for="nro_sisco">Nro sisco:</label><br>
											<input type="text" id="nro_sisco" name="nro_sisco" required><br>
											...
											<label for="notificar">Notificar:</label><br>
											<input type="number" id="notificar" name="notificar" required><br>

											<label for="foto">Foto de la carta:</label><br>
