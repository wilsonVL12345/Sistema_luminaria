				...
				<div class="card-body pt-9 pb-0">
					...
					<div class="margin">
						...
						{{-- <button class="btn btn-success " data-bs-toggle="modal" data-bs-target="#Modalregistrarinspeccionesespera">Agregar Usuario</button>
						 --}}<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Agregar Nuevo</a>
										...
										<form id="kt_modal_new_target_form" class="form" action="{{route('registro.inspecciones')}}" method="POST" enctype="multipart/form-data">
											...
											<div class="row g-9 mb-8">
												...
												<div class="col-md-6 fv-row">
													...
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Seleccione..." name="txtdistirto" id="txtdistirto">
												...
												<div class="col-md-6 fv-row">
													...
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Seleccione..." name="txtzonaurb" id="txtzonaurb">
														<option value=""  >Seleccione...</option>
														@foreach ($listazonaurb as $ite)
															<option value="{{$ite->Zona_Urbanizacion}}">{{$ite->Zona_Urbanizacion}}</option>
														@endforeach
