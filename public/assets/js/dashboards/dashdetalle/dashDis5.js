  ...
  function fetchDataAndDrawChart() {
    ...
    $.ajax({
      ...
      success: function(response) {
        drawChart(response[5]); // Usamos solo los datos del distrito 1
      },
  ...
  function drawChart(distritoDatos) {
    ...
    let options = {
      title: 'Actividades Distritales - Distrito 5',
      colors: ['#ADD8E6', '#00BFFF', '#FF6666', '#2abe81', '#0000FF'],
      width: 800,
      height: 600
    };
  
    let chart = new google.visualization.PieChart(document.getElementById('dis5'));
