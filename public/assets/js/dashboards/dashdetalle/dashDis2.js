  ...
  function fetchDataAndDrawChart() {
    ...
    $.ajax({
      ...
      success: function(response) {
        drawChart(response[2]); // Usamos solo los datos del distrito 1
      },
  ...
  function drawChart(distritoDatos) {
    ...
    let options = {
      title: 'Actividades Distritales - Distrito 2',
      colors: ['#ADD8E6', '#00BFFF', '#FF6666', '#2abe81', '#0000FF'],
      width: 800,
      height: 600
    };
  
    let charts = new google.visualization.PieChart(document.getElementById('dis2'));
